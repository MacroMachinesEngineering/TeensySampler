...
AudioInputI2S            i2s2;           //xy=332,376
AudioAnalyzePeak         peak1;          //xy=465,365
AudioRecordQueue         queue1;         //xy=465,400
AudioPlaySdRaw           playRaw1;       //xy=609,374
AudioOutputI2S           i2s1;           //xy=737,374
AudioConnection          patchCord1(i2s2, 0, peak1, 0);
AudioConnection          patchCord2(i2s2, 0, queue1, 0);
AudioConnection          patchCord3(playRaw1, 0, i2s1, 0);
AudioConnection          patchCord4(playRaw1, 0, i2s1, 1);
AudioControlSGTL5000     sgtl5000_1;     //xy=565,523
